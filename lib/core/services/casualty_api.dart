...
class CasualtyApi {
  ...
  static Future<List<Casualty>> getCasualties() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (responseData['success'] == true) {
        ...
        throw Exception(
          responseData['message'] ?? 'فشل في تحميل بيانات الشهداء والجرحى',
        );
      }
    } else {
      throw Exception(
  ...
  static Future<Casualty> getCasualty(int id) async {
    final response = await http.get(
      Uri.parse('$baseUrl/personnel-casualties/$id'),
    );
  ...
  static Future<List<MartyrCompensation>> getMartyrCompensations() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (responseData['success'] == true) {
        ...
        throw Exception(
          responseData['message'] ?? 'فشل في تحميل تعويضات الشهداء',
        );
      }
    } else {
      throw Exception(
        'فشل في تحميل تعويضات الشهداء - رمز الخطأ: ${response.statusCode}',
      );
    }
  }
  ...
  static Future<MartyrCompensation> getMartyrCompensation(int id) async {
    final response = await http.get(
      Uri.parse('$baseUrl/martyr-compensation/$id'),
    );
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
        'فشل في تحميل تعويض الشهيد - رمز الخطأ: ${response.statusCode}',
      );
    }
  }

  static Future<MartyrCompensation> createMartyrCompensation(
    MartyrCompensation compensation,
  ) async {
    final response = await http.post(
    ...
    if (response.statusCode == 201) {
      ...
      throw Exception(
        'فشل في إنشاء تعويض الشهيد - رمز الخطأ: ${response.statusCode}',
      );
    }
  }

  static Future<MartyrCompensation> updateMartyrCompensation(
    MartyrCompensation compensation,
  ) async {
    final response = await http.put(
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
        'فشل في تحديث تعويض الشهيد - رمز الخطأ: ${response.statusCode}',
      );
    }
  }
  ...
  static Future<void> deleteMartyrCompensation(int id) async {
    ...
    if (response.statusCode != 200) {
      throw Exception(
        'فشل في حذف تعويض الشهيد - رمز الخطأ: ${response.statusCode}',
      );
    }
  }
  ...
  static Future<MartyrCompensation?> getCompensationByCasualtyId(
    int casualtyId,
  ) async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/martyr-compensation/casualty/$casualtyId'),
      );
  ...
  static Future<Map<String, dynamic>> getCasualtyStats() async {
    final response = await http.get(
      Uri.parse('$baseUrl/personnel-casualties/stats'),
    );
  ...
  static Future<List<Casualty>> getByPersonnelId(int personnelId) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (responseData['success'] == true) {
        ...
        throw Exception(
          responseData['message'] ?? 'فشل في تحميل سجلات المستنفر',
        );
      }
    } else {
      throw Exception(
        'فشل في تحميل سجلات المستنفر - رمز الخطأ: ${response.statusCode}',
      );
    }
  }

  static Future<bool> checkDuplicateRecord(
    int personnelId,
    String caseType,
  ) async {
    try {
      final response = await http.get(
        Uri.parse(
          '$baseUrl/personnel-casualties/check-duplicate/$personnelId/$caseType',
        ),
      );
  ...
  static Future<List<Casualty>> searchCasualties(String term) async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/personnel-casualties/search/$term'),
      );
